...
export const ExpenseTracker: React.FC = () => {
  ...
  // Memoize chart data to avoid redundant O(N) calculations on every re-render
  // This is especially important as the component grows and re-renders frequently
  // during form input interactions.
