...
export const PlanCreator: React.FC<PlanCreatorProps> = ({ onPlanGenerated }) => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    setLoading(true);
    try {
      // ⚡ Bolt: Parallelize independent AI service calls to reduce total latency.
      // This reduces waiting time by up to 50% by fetching the itinerary and destination image simultaneously.
