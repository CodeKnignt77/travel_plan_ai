...
export const PlanCreator: React.FC<PlanCreatorProps> = ({ onPlanGenerated }) => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    setLoading(true);
    try {
      // ⚡ BOLT OPTIMIZATION: Parallelize AI service calls to reduce critical path latency.
      // Fetching itinerary and destination image concurrently saves significant time
