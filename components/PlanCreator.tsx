...
export const PlanCreator: React.FC<PlanCreatorProps> = ({ onPlanGenerated }) => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    setLoading(true);
    try {
      // Parallelize AI calls to reduce total critical path latency
      // This implementation reduces total wait time by executing both independent promises concurrently
