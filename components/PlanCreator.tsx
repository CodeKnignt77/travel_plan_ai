...
export const PlanCreator: React.FC<PlanCreatorProps> = ({ onPlanGenerated }) => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    setLoading(true);
    try {
      // PERFORMANCE OPTIMIZATION: Parallelizing independent AI service calls
      // This reduces total latency by running itinerary generation and image generation concurrently.
