...
export const PlanCreator: React.FC<PlanCreatorProps> = ({ onPlanGenerated }) => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    e.preventDefault();
    setLoading(true);
    console.time("AI_Service_Calls_Parallel"); // Bolt: Measure parallel execution performance
    try {
      // Parallelizing independent AI calls reduces total latency significantly
